...
namespace UnitTestWriting.Tests.Domain
{
    ...
    {
        [Fact]
        public void Ctor_NewCart_ReturnUserName()
        {
            // Arrange
            ...
            // Assert
            Assert.Equal(cart.Customer.Name, user.Name);
        }
        [Fact]
        public void Ctor_NewCart_ReturnEmptyProducts()
        {
            // Arrange
            var user = new User { Name = "test" };
            // Act
        ...
        [Theory]
        [InlineData(null, null, 1, 1, 2, 4, 0)]
        [InlineData(null, null, 1, 1, 1, 1, 5)]
        [InlineData(9, null, 1, 1, 2, 4, 9)]
        [InlineData(null, 9, 1, 1, 2, 4, 9)]
        [InlineData(10, 10, 1, 1, 2, 4, 20)]
        ...
        [Theory]
        //[InlineData(0)] - дисконт может быть 0%. Выбрасывать исключение это неправильно
        [InlineData(-1)]
        [InlineData(100)]
        [InlineData(101)]
